...
|---|---|
| 作成日 | 2026-04-28 |
| 改訂日 | 2026-04-28 (即時リリース方針 + 今日完走モード) |
| ステータス | **改訂版 r2** — 24h 観察ゲート撤廃 + 全フェーズ今日完走モードに合わせ効率化 |
...
立ち会い実施者は **user 自身 (本部役 兼 動作確認実施者)**。B-3a 動作確認も user 自身が実施した前例を踏襲、<client_A> さんへの依頼による timing 待ちを発生させない。
